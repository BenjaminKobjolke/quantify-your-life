...
Counts the total number of lines added by the configured author across all repositories.
...
2. Extract the first column (added lines)
3. Sum all added values across all commits
