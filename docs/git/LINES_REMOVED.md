...
Counts the total number of lines removed by the configured author across all repositories.
...
2. Extract the second column (removed lines)
3. Sum all removed values across all commits
4. Apply exclusion filters (directories, extensions, filenames)
